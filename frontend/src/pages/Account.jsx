...
const Account = () => {
    ...
    const handleExport = async () => {
        ...
        try {
            ...
            setStatus({
                type: 'success',
                msg: 'Vos données ont été exportées.',
            });
        } catch (err) {
            setStatus({
                type: 'error',
                msg: err.message || 'Export impossible.',
            });
        } finally {
            setLoading('');
        }
    ...
    const handleDelete = async () => {
        if (
            !window.confirm(
                'Supprimer définitivement votre compte et vos articles ?',
            )
        )
            return;
        setLoading('delete');
    ...
    return (
        <section className="login-container container-narrow">
            ...
            <p className="login-signup">
                Consultez notre{' '}
                <Link to="/confidentialite" className="login-signup-link">
