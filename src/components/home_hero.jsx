    ...
    return (
        <section className='home-hero-container container-narrow'>
            ...
            <div className='home-hero-buttons'>
                <button className='home-hero-button'>Découvrir les articles</button>
                <button className='home-hero-button home-hero-button-secondary'>S'abonner à la newsletter</button>
            </div>
        </section>
    );
};
